...
public class UnionPlannerTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testSimpleUnion() {
        ...
        assertThat(plan, instanceOf(UnionPlan.class));
        UnionPlan unionPlan = (UnionPlan) plan;
        assertThat(unionPlan.orderBy(), is(nullValue()));
        assertThat(unionPlan.mergePhase().numInputs(), is(2));
        assertThat(unionPlan.left(), instanceOf(Collect.class));
        assertThat(unionPlan.right(), instanceOf(Collect.class));
    }
    ...
    public void testUnionWithOrderByLimit() {
        ...
        assertThat(unionPlan.mergePhase().numInputs(), is(2));
        assertThat(unionPlan.orderBy(), is(nullValue()));
        assertThat(unionPlan.mergePhase().projections(), contains(
    ...
    public void testUnionWithSubselects() {
        ...
        assertThat(unionPlan.left(), instanceOf(Merge.class));
        Merge merge = (Merge) unionPlan.left();
